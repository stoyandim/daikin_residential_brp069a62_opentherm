...
DAIKIN_CMD_SETS = {
    ...
    #new
    ATTR_ECO_MODE: [MP_CLIMATE, DP_ECO_MODE, ""],
...
# NEW 1.0
DAIKIN_SWITCHES = [SWITCH_CLIMATE_ONOFF,SWITCH_CLIMATE_ECO,SWITCH_DHW_TANK_ONOFF,SWITCH_POWERFUL_ONOFF,]
DAIKIN_SWITCHES_ICONS ={SWITCH_CLIMATE_ONOFF:'mdi:thermometer-lines',SWITCH_CLIMATE_ECO:'mdi:alpha-e-circle-outline',SWITCH_DHW_TANK_ONOFF:'mdi:bathtub-outline',SWITCH_POWERFUL_ONOFF:'mdi:bike-fast'}
